        ...
        case MODE_THREAD:
            {
                ...
                // h5.ino style: Let the main loop handle Z positioning via spindle sync
                // DON'T constantly set new targets - this interrupts smooth motion!
                // The main loop's spindle sync will handle continuous Z movement
