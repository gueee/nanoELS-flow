...
// Encoder configuration (hardware PCNT-based)
struct EncoderConfig {
    uint8_t pinA;
    uint8_t pinB;
    pcnt_unit_t pcntUnit;       // PCNT unit assignment
    ...
    // Hardware PCNT handles debouncing automatically
    bool usePCNT;               // Use hardware PCNT vs software interrupts
};
